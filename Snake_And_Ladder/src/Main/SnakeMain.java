...
public class SnakeMain extends JFrame {
	...
	public void Dice() {
		...
		lblDimage.setIcon(new ImageIcon(SnakeMain.class.getResource(location)));
	...
	public SnakeMain(String player1_usernames, String player2_usernames) {
	...
	public static void playStaticSound() {
		try {
			...
			AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(
					SnakeMain.class.getResourceAsStream("/Image/dice-roll-sound.wav")); // Replace with your sound file path
	...
	public void initialize(String player1_usernames, String player2_usernames) {
				...
				if (chokka == 0) {
					if (winingPosition == 2) {
						...
						if (confirm == JOptionPane.YES_OPTION) {
							dispose();
							SnakeMain frame = new SnakeMain(player1_username, player2_username);
		...
		lblBoard.setIcon(new ImageIcon(SnakeMain.class.getResource("/Image/Board Small 600 600.png")));
		...
		p1btn = new JLabel("");
		p1btn.setIcon(new ImageIcon(SnakeMain.class.getResource("/Image/player 1.png")));
		p1btn.setBounds(884, 312, 50, 50);
		contentPane.add(p1btn);

		label = new JLabel("");
		label.setIcon(new ImageIcon(SnakeMain.class.getResource("/Image/player 2.png")));
